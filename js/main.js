...
/* harmony import */ var _components_counter_reset_li__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/_counter-reset-li */ "./src/js/components/_counter-reset-li.js");
console.log('components');
// Li count for episodes

_components_counter_reset_li__WEBPACK_IMPORTED_MODULE_0__.changeCounter();
...
/***/ "./src/js/components/_counter-reset-li.js":
/*!************************************************!*\
  !*** ./src/js/components/_counter-reset-li.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   changeCounter: () => (/* binding */ changeCounter)
/* harmony export */ });
function changeCounter() {
  const episodesLi = document.querySelectorAll('.episodes__item');
  const episodesLiLength = episodesLi.length + 1;
  const episodeList = document.querySelector('.episodes__list');
  episodeList.style.counterReset = "number" + " " + episodesLiLength;
}
